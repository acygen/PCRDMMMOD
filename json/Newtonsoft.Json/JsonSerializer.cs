...
using Newtonsoft0.Json.Serialization;
...
namespace Newtonsoft0.Json
{
	public class JsonSerializer
	{
		...
		public virtual event EventHandler<Newtonsoft0.Json.Serialization.ErrorEventArgs> Error;
		...
		public static JsonSerializer Create(JsonSerializerSettings settings)
		{
			...
			if (settings != null)
			{
				...
				{
					jsonSerializer.Error = (EventHandler<Newtonsoft0.Json.Serialization.ErrorEventArgs>)Delegate.Combine(jsonSerializer.Error, settings.Error);
				}
		...
		internal void OnError(Newtonsoft0.Json.Serialization.ErrorEventArgs e)
		{
